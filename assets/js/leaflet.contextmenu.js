...
var BASE_CLS = 'leaflet-contextmenu';
...
L.Map.ContextMenu = L.Handler.extend({
	...
	initialize: function (map) {
        ...
        var baseclass = BASE_CLS;
		var container = this._container = L.DomUtil.create('div', baseclass, map._container);
	...
	_createItem: function (container, options, index) {
		...
		if (options.icon) {
			html = '<img class="' + BASE_CLS + '-icon" src="' + options.icon + '"/>';
		} else if (options.iconCls) {
			html = '<span class="' + BASE_CLS + '-icon ' + options.iconCls + '"></span>';
		}
