    ...
    _addMethods: function() {
        ...
        this._parseOptions = function(options) {
            ...
            if(!options.pointIcon)
                this._options.pointIcon = L.icon({ iconUrl: '/assets/images/editmarker.png', iconSize: [11, 11], iconAnchor: [6, 6] });
            if(!options.newPointIcon)
                this._options.newPointIcon = L.icon({ iconUrl: '/assets/images/editmarker2.png', iconSize: [11, 11], iconAnchor: [6, 6] });
        };
